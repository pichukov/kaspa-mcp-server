...
/**
 * Simple Kaspa MCP Client Example
 * 
...
async function main() {
  ...
  try {
    ...
    // Example 3: Create a wallet (using generated mnemonic)
    ...
    // Keep running for 30 seconds to see balance notifications
    console.log('\n⏰ Waiting 30 seconds for any balance change notifications...');
